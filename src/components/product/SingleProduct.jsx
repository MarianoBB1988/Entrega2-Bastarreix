                    ...
                    <div className="card shadow" >
                        ...
                        <div className="row" >
                            ...
                            <div className="card-body col-4"  >
                                <a href="#" onClick={() => abrirLigthbox('http://http2.mlstatic.com/D_' + producto.thumbnail_id + '-O.webb')}><img class="img-fluid" alt="Responsive image" style={imgEstilo} src={'http://http2.mlstatic.com/D_' + producto.thumbnail_id + '-O.webb'} /></a>
